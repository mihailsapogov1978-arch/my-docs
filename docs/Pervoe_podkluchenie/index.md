...
# Установлено программное обеспечение КриптоПро CSP 4.0 и выше: 
...
13. После первого входа из меню \ открыть настройки клиента и во вкладке \ выбрать сервер обновлений win-stim.krista.ru:8080. Также поставить галочку на \
...
4.  При подключении ввести адрес сервера: [[https://smeta-app.yanao.ru:443]](https://smeta-app.yanao.ru:443/)

5.  После первого входа из меню \ открыть настройки клиента и во вкладке \ выбрать сервер обновлений win-stim.krista.ru:8080. Также поставить галочку на \
