...
<span class="twemoji icon-download">:material-download:</span> **Загрузите программное обеспечение ГИС «Смета ЯНАО»**
...
=== "РЕД ОС"
    ...
    7.  **Настройки:** После первого входа в меню <Настройки> → <Программа>:
        *   Сервер обновлений: `win-stim.krista.ru:8080`
        *   Галочка: <Регистрация для запуска приложения из браузера>
...
=== "Windows"
    ...
    5.  Адрес сервера: `https://smeta-app.yanao.ru:443`
    6.  **Настройки:** После первого входа в меню <Настройки> → <Программа>:
        *   Сервер обновлений: `win-stim.krista.ru:8080`
        *   Галочка: <Регистрация для запуска приложения из браузера>
