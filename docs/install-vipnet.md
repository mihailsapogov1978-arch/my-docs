## Установка и настройка клиентского программного обеспечения ГИС «Смета ЯНАО» на автоматизированных рабочих местах с использованием VipNet Client {data-toc-label="Установка ViPNet"}

## Установить и настроить вспомогательное программное обеспечение.

!!! warning "VipNET клиент. Необходимо проверить доступность сетевого узла LARM-Sal-CB-ServSmetaSP"
